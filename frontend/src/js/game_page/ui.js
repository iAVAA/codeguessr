...
function initAddFriendSearch() {
    ...
    const openModal = () => {
        ...
        if (results) results.innerHTML = '<div class="cg-search-empty">Inizia a digitare per cercare giocatori...</div>';
    };
    ...
    const debouncedSearch = debounce((q) => renderFriendSearchResults(results, q), 300);
