...
## Cos'è CodeGuessr? 💡
A differenza dei normali giochi di programmazione, qui non devi limitarti a indovinare il linguaggio. Il tuo obiettivo è **analizzare** un frammento di codice nascosto e **spiegare** esattamente cosa fa, che algoritmo sta implementando e qual è la sua *complessità computazionale*.

## Come Giocare 🎮

1. **Osserva il Codice:** Ad ogni round ti verrà mostrato uno "snippet" esilarante, complesso o ambiguo all'interno dell'editor.
